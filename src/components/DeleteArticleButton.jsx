...
export const DeleteArticleButton = (props) => {
  ...
  return (
    <button className="bg-red-500 hover:bg-red-600 text-white text-center font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" onClick={deleteArticleButton}>Supprimer</button>
  )
};
